...
public class ProcessRemoveNumberFromBetCart extends HttpServlet {
	public void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		String betCartItems = (String)session.getAttribute("betCart");
		if(betCartItems == null){
			betCartItems = " ";
		}else{
			Object obj = JSONValue.parse(betCartItems);
